...
2. ANÁLISIS AMPLIADO: cumple 4 funciones en un solo texto corto y directo — (a) REFORZAR el diagnóstico planteado, (b) EXPLICAR brevemente el razonamiento (qué hallazgos llevan a ese diagnóstico), (c) AGREGAR los complementos que lo refuerzan (hallazgos de apoyo, riesgo, resultado de escalas si ya se calcularon), y (d) PLANTEAR la conducta/tratamiento inicial (qué se inicia o solicita, en una frase final). Redáctalo TAL COMO SE DOCUMENTA EN LA PRÁCTICA REAL de un servicio de urgencias — corto, directo, sin explicar de más el razonamiento. Un médico en la práctica NO escribe párrafos tipo ensayo explicando por qué cada síntoma sustenta el diagnóstico ("estos síntomas constituyen equivalentes anginosos clásicos y, sumados a la carga de enfermedad previa, sustentan de forma directa el diagnóstico de...") — eso es lenguaje de libro de texto, no de historia clínica real. En su lugar, PLANTEA los hallazgos y la conclusión directamente, en frases cortas: "PACIENTE CON [antecedente clave] QUE CONSULTA POR [síntoma] + [equivalentes/hallazgos]. [Conclusión directa sobre riesgo/diagnóstico]. [Estado actual, breve]. [Conducta/tratamiento inicial, breve]." Evita conectores explicativos largos ("lo que es compatible con...", "esto sustenta que...") — ve directo al hallazgo, la conclusión, y la conducta. Prioriza que sea breve y utilizable tal cual, no que suene completo o exhaustivo, pero SIN omitir la conducta/tratamiento — esa parte no es opcional.
...
7. SECCIONES DE HISTORIA CLÍNICA LISTAS PARA COPIAR: redacta 3 secciones ya completas y listas para pegar en la nota — "ANÁLISIS" (mismo texto corto y directo del punto 2, sin volverlo más largo ni más explicativo), "DIAGNÓSTICOS" (el diagnóstico reafirmado + diferenciales relevantes con CIE-10, planteados como diagnósticos, no como "posibles" o "sugeridos"), y "PLAN" (estudios a solicitar, en formato de orden médica directa: "SOLICITAR...", nunca "se sugiere solicitar..."). Las 3 secciones deben leerse EXACTAMENTE como si el médico ya las hubiera escrito en su historia clínica — texto corrido, en mayúsculas, corto y directo (ver estilo del punto 2), sin lenguaje de sugerencia, comentario o interpretación, y sin repetir explicaciones de las secciones anteriores.
...
ESTUDIO_PARA_SCORE: TROPONINA SERIADA PARA COMPLETAR HEART SCORE
ARGUMENTO:
EQUIVALENTES ANGINOSOS (DIAFORESIS, DEBILIDAD, VÓMITO) + ANTECEDENTE DE ENFERMEDAD CORONARIA (3 PUENTES, 2 STENTS). ALTO RIESGO DE RECURRENCIA DE SCA.
@@@ANALISIS@@@
PACIENTE CON ANTECEDENTE DE ENFERMEDAD CORONARIA (3 PUENTES, 2 STENTS) QUE CONSULTA POR DOLOR TORÁCICO + EQUIVALENTES ANGINOSOS (DIAFORESIS, DEBILIDAD, VÓMITO). ALTO RIESGO DE RECURRENCIA DE SCA POR CARGA CORONARIA PREVIA. HEMODINÁMICAMENTE ESTABLE AL MOMENTO, SIN SIGNOS DE FALLA CARDÍACA. NO DESCARTA ISQUEMIA EN CURSO POR TIEMPO CORTO DE EVOLUCIÓN. SE INICIA DOBLE ANTIAGREGACIÓN Y ESTATINA DE ALTA INTENSIDAD, SE SOLICITA TROPONINA SERIADA Y ECG DE CONTROL, Y SE DEJA EN OBSERVACIÓN MONITORIZADA.
@@@ESCALA@@@
NOMBRE: HEART Score
